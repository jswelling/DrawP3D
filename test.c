...
static P_Color pline_color= { P3D_RGB, 0.2, 0.2, 1.0, 1.0 };
...
#ifdef never
  ERRCHK( dp_polygon( P3D_CVTX, P3D_RGB, pline_coords, 3 ) );
  ERRCHK( dp_polymarker( P3D_CVTX, P3D_RGB, pline_coords, 3 ) );
#endif
